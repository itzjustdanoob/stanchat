        ...
        <div className="border-t-2 border-dashed border-ink/20 py-1">
          <div className={cn(rowClass, "cursor-default hover:bg-transparent")}>
            ...
            <button
              ...
              className={cn(
                "ml-auto relative inline-flex h-5 w-9 items-center rounded-full border-2 border-ink transition-colors",
            ...
            >
              <span
                className={cn(
                  "inline-block h-3 w-3 rounded-full bg-paper transition-transform",
                  user.modMode ? "translate-x-4" : "translate-x-0.5",
                )}
              />
            </button>
          </div>
